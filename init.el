...
;; Company (global auto-complete)
(use-package company
  :init (global-company-mode))

;; Auto C++ header includes
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(header2 cpp-auto-include counsel which-key ivy-rich ivy use-package company doom-themes doom-modeline)))
(custom-set-faces)
